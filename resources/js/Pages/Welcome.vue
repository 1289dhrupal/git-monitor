            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        ...
                        >
                            <Button
                                label="Dashboard"
                                link
                                class="!px-3 !py-2 !text-black dark:!text-white"
                            />
                        </Link>
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <Card
                            id="docs-card"
                            class="!rounded-lg !shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] !ring-1 !ring-white/[0.05] dark:!bg-zinc-900 dark:!ring-zinc-800"
                        >
                            <template #content>
                                <a
                                    href="https://laravel.com/docs"
                                    class="flex flex-col items-start gap-6 overflow-hidden transition duration-300 hover:text-black/70 focus:outline-none dark:hover:text-white/70"
                                >
                                    <div
                        ...
                        >
                            <template #content>
                                <a
                                    ...
                                    class="flex items-start gap-4 transition duration-300 hover:text-black/70 focus:outline-none dark:hover:text-white/70"
                                >
                                    <div
                                        class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16"
                                    >
